<template>
  ...
  <v-toolbar app fixed dark class="grey lighten-3">
    <v-toolbar-side-icon dark @click.stop="drawer = !drawer" ></v-toolbar-side-icon>
    <v-toolbar-title class="mr-5 align-center black--text" style="color:grey;font-size:17px;">
      <span @click.stop="toRoute('home')"> 우리동네 맘카페 </span>
    </v-toolbar-title>
